...
const App = () => {
  ...
  const syncScroll = () => {
    ...
    renderedOutput.scrollTop =
      scrollPercentage * (renderedOutput.scrollHeight - renderedOutput.clientHeight);
  };
    ...
    <div style={{ display: "flex", height: "100vh" }}>
      ...
      >
        ...
        <textarea
          ...
          style={{ width: "100%", height: "90%", fontSize: "16px", overflowY: "auto" }}
        />
      ...
      >
        ...
        <div
          ref={renderedRef}
          style={{ border: "1px solid #ccc", padding: "20px", height: "90%", overflowY: "auto" }}
        >
